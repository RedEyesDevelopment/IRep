...
insert into IDEAS (IDEA_NAME, DESCRIPTION, IDEA_IMAGE, IDEA_AUTHOR_ID) values ('idea2', 'I hev idea2', 'kartinka', '2');
insert into IDEAS (IDEA_NAME, DESCRIPTION, IDEA_AUTHOR_ID) values ('idea3', 'I hev idea3', '3');

insert into CONTENTS (CONTENT_ID, IDEA_CONTENT) values (1, 'framework created by Gavin King in 2001.');
insert into CONTENTS (CONTENT_ID, IDEA_CONTENT) values (2, 'It is a powerful.');
insert into CONTENTS (CONTENT_ID, IDEA_CONTENT) values (3, 'Hibernate maps Java classes.');
