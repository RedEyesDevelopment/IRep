DROP DATABASE IF EXISTS `ideaperository`;
CREATE DATABASE `ideaperository` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;
...
CREATE TABLE IDEAS (
    ...
    IDEA_AUTHOR_ID BIGINT NOT NULL,
    POSTED_DATE TIMESTAMP NOT NULL DEFAULT NOW(),
    VIEWED_DATE TIMESTAMP NOT NULL DEFAULT NOW(),
    VIEWED_COUNT BIGINT NOT NULL DEFAULT 0,
    IDEA_ENABLED BIT NOT NULL DEFAULT 1,
    UNIQUE UQ_IDEA_MAG_1 (IDEA_ID),
    PRIMARY KEY (IDEA_ID),
    CONSTRAINT FK_IDEA_AUTHOR_1 FOREIGN KEY (IDEA_AUTHOR_ID) REFERENCES USERS (USER_ID) );
...
CREATE TABLE CONTENTS (
    ...
    UNIQUE UQ_CONTENT_IDEA_1 (CONTENT_IDEA_ID),
    PRIMARY KEY (CONTENT_ID),
    CONSTRAINT FK_CONTENT_IDEA_1 FOREIGN KEY (CONTENT_IDEA_ID) REFERENCES IDEAS (IDEA_ID) ON DELETE CASCADE ON UPDATE CASCADE);
...
CREATE TABLE COMMENTS (
    ...
    CONSTRAINT FK_AUTHOR_COMMENT_1 FOREIGN KEY (COMMENT_AUTHOR_ID) REFERENCES USERS (USER_ID),
    CONSTRAINT FK_IDEA_COMMENT_1 FOREIGN KEY (COMMENT_IDEA_ID) REFERENCES IDEAS (IDEA_ID) );
...
CREATE TABLE TAG_MAGAZINE (
    ...
    KEY (TAG_MAG_ID),
    KEY (TAG_IDEA_ID),
    CONSTRAINT FK_TAGMAG_TAGS_1 FOREIGN KEY (TAG_MAG_ID) REFERENCES TAGS (TAG_ID),
    CONSTRAINT FK_TAGMAG_IDEA_1 FOREIGN KEY (TAG_IDEA_ID) REFERENCES IDEAS (IDEA_ID) );
